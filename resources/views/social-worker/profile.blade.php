                ...
                <div class="card-body">
                    ...
                    <div class="text-start mt-3">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            @if($user->avatar)
                                <form action="{{ route('social-worker.profile.remove-avatar') }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane show active" id="profile-tab">
                            <form action="{{ route('social-worker.profile.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                        ...
                        <div class="tab-pane" id="password-tab">
                            <form action="{{ route('social-worker.profile.password') }}" method="POST">
                                @csrf
                                @method('PUT')
